...
const typescript_2 = require("../../mappers/typescript");
const grammar_1 = require("../../parser/grammar");
const parser_1 = require("../../parser/parser");
const scope_1 = require("../../parser/scope");
const tsGrammar = (0, grammar_1.compileGrammar)(typescript_1.grammar);
const pool = new scope_1.ScopePool();
...
function* transform(texts) {
    for (const parsed of texts) {
        if (doesScopeMatch(parsed.scope, 'constant.character.escape.ts')) {
            const mapped = (0, typescript_2.mapRawString)(parsed.text);
...
function mergeParsedText(a, b) {
    const abT = (0, appendMappedText_1.appendMappedText)(a, b);
    const ab = {
        text: abT.text,
        scope: a.scope,
