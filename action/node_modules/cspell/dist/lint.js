...
async function runLint(cfg) {
    ...
    async function processFile(fileInfo, configInfo) {
        ...
        reporter.debug(`Filename: ${fileInfo.filename}, LanguageIds: ${(_a = doc.languageId) !== null && _a !== void 0 ? _a : 'default'}`);
        const result = {
            fileInfo,
            issues: [],
            processed: false,
    ...
    async function processFiles(files, configInfo, fileCount) {
        ...
        for (const fileP of files) {
            ...
            const emitProgress = (elapsedTimeMs, processed, numErrors) => reporter.progress({
