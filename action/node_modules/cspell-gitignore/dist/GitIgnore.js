...
class GitIgnore {
    ...
    async _findGitIgnoreHierarchy(directory) {
        ...
        const parentHierarchy = parent !== directory && (0, helpers_1.contains)(root, parent) ? await this.findGitIgnoreHierarchy(parent) : undefined;
    ...
    determineRoot(directory) {
        ...
        for (let i = roots.length - 1; i >= 0; --i) {
            const r = roots[i];
            if ((0, helpers_1.contains)(r, directory))
                return r;
        }
