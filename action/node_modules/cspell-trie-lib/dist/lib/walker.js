...
function* hintedWalker(root, ignoreCase, hint, compoundingMethod) {
    ...
    const rawRoots = [root, ignoreCase ? root.c.get(noCaseCharacter) : undefined].filter(util_1.isDefined);
    ...
    const compoundRoots = rawRoots.map((r) => { var _a; return (_a = r.c) === null || _a === void 0 ? void 0 : _a.get(compoundCharacter); }).filter(util_1.isDefined);
