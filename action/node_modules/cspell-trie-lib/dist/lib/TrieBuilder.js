...
function buildTrieFast(words, trieOptions) {
    const root = (0, util_1.createTriFromList)(words, trieOptions);
...
class TrieBuilder {
    constructor(words, trieOptions) {
        ...
        this.trieOptions = Object.freeze((0, util_1.mergeOptionalWithDefaults)(trieOptions));
        if (words) {
            this.insert(words);
        }
    }
    ...
    get _root() {
        return (0, util_1.trieNodeToRoot)(this.lastPath[0].n, this.trieOptions);
    }
    signature(n) {
        const isWord = n.f ? '*' : '';
