...
class Trie {
    ...
    suggestWithCost(text, maxNumSuggestions, compoundMethod, numChanges, ignoreCase) {
        return suggest_1.suggest(this.getSuggestRoot(!ignoreCase), text, maxNumSuggestions, compoundMethod, numChanges, ignoreCase).filter((sug) => !this.isForbiddenWord(sug.word));
    }
    /**
    ...
    genSuggestions(collector, compoundMethod) {
        ...
        const suggestions = suggest_1.genSuggestions(this.getSuggestRoot(!collector.ignoreCase), collector.word, compoundMethod);
