...
const joinLetters_1 = require("./joinLetters");
function parseAlphabet(cs, locale, editCost) {
    ...
    const alphabet = (0, joinLetters_1.joinLetters)([
...
function parseAlphabetCaps(alphabet, locale, editCost) {
    ...
    const caps = charForms.map((a) => (0, joinLetters_1.joinLetters)(a)).join('|');
    const sugCaps = {
        map: caps,
...
function parseAccents(cs, _editCost) {
    const { cost, penalty } = cs;
    const accents = (0, joinLetters_1.joinLetters)([
...
function calcCostsForAccentedLetters(simpleMap, locale, costs) {
    ...
    const characters = (0, sync_1.pipe)(charactersWithAccents, (0, sync_1.opMap)((forms) => new Set([...forms, ...forms.map((char) => (0, text_1.stripAccents)(char))])), (0, sync_1.opMap)((forms) => [...forms].sort()), (0, sync_1.opFilter)((forms) => forms.length > 1), (0, sync_1.opMap)(joinLetters_1.joinLetters), (0, sync_1.opUnique)());
