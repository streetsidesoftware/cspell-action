...
const walker_1 = require("./walker/walker");
...
function createTrieRoot(options) {
    const fullOptions = (0, mergeOptionalWithDefaults_1.mergeOptionalWithDefaults)(options);
    return {
        ...fullOptions,
        c: new Map(),
    };
...
function trieNodeToRoot(node, options) {
    const newOptions = (0, mergeOptionalWithDefaults_1.mergeOptionalWithDefaults)(options);
    return {
        ...newOptions,
        c: node.c || new Map(),
    };
