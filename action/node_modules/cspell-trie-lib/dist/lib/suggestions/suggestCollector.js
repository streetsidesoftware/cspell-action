...
function suggestionCollector(wordToMatch, options) {
    ...
    const useSeparator = compoundSeparator ||
        (weightMap ? constants_1.DEFAULT_COMPOUNDED_WORD_SEPARATOR : exports.defaultSuggestionCollectorOptions.compoundSeparator);
    ...
    function suggestions() {
        ...
        const values = weightMap
            ? rawValues.map(({ word, isPreferred }) => ({
                word,
                cost: (0, distance_1.editDistanceWeighted)(nWordToMatch, word.normalize(NF), weightMap, 110),
                isPreferred,
            }))
            : rawValues;
