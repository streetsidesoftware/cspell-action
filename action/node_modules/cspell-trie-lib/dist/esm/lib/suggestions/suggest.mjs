import { isWordTerminationNode } from '../trie-util.mjs';
import { clean } from '../utils/clean.mjs';
import { CompoundWordsMethod, hintedWalker, JOIN_SEPARATOR, WORD_SEPARATOR } from '../walker/index.mjs';
import { createSuggestionOptions } from './genSuggestionsOptions.mjs';
import { visualLetterMaskMap } from './orthography.mjs';
import { suggestionCollector } from './suggestCollector.mjs';
const baseCost = 100;
const swapCost = 75;
