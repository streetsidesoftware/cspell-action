...
import { caseForms } from '../utils/text.mjs';
import { isDefined, unique as uniqueU } from '../utils/util.mjs';
import { joinLetters } from './joinLetters.mjs';
import { mapHunspellCosts } from './mapCosts.mjs';
import { calcCostsForAccentedLetters, calcFirstCharacterReplace, parseAlphabet, splitMap, } from './mapToSuggestionCostDef.mjs';
