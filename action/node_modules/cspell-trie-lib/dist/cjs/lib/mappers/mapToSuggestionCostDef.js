...
function calcCostsForAccentedLetters(simpleMap, locale, costs) {
    ...
    const characters = (0, sync_1.pipe)(charactersWithAccents, (0, sync_1.opMap)((forms) => new Set([...forms, ...forms.map((char) => (0, text_js_1.stripAccents)(char))])), (0, sync_1.opMap)((forms) => [...forms].sort()), (0, sync_1.opFilter)((forms) => forms.length > 1), (0, sync_1.opMap)(joinLetters_js_1.joinLetters), (0, sync_1.opUnique)());
