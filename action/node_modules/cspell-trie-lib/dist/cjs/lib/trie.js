...
const suggest_js_1 = require("./suggest.js");
const trie_util_js_1 = require("./trie-util.js");
const clean_js_1 = require("./utils/clean.js");
const mergeOptionalWithDefaults_js_1 = require("./utils/mergeOptionalWithDefaults.js");
const util_js_1 = require("./utils/util.js");
const index_js_1 = require("./walker/index.js");
var constants_js_2 = require("./constants.js");
Object.defineProperty(exports, "CASE_INSENSITIVE_PREFIX", { enumerable: true, get: function () { return constants_js_2.CASE_INSENSITIVE_PREFIX; } });
Object.defineProperty(exports, "COMPOUND_FIX", { enumerable: true, get: function () { return constants_js_2.COMPOUND_FIX; } });
Object.defineProperty(exports, "defaultTrieOptions", { enumerable: true, get: function () { return constants_js_2.defaultTrieOptions; } });
Object.defineProperty(exports, "FORBID_PREFIX", { enumerable: true, get: function () { return constants_js_2.FORBID_PREFIX; } });
Object.defineProperty(exports, "OPTIONAL_COMPOUND_FIX", { enumerable: true, get: function () { return constants_js_2.OPTIONAL_COMPOUND_FIX; } });
/** @deprecated */
...
class Trie {
    ...
    findWord(word, options) {
        if (options?.useLegacyWordCompounds) {
            ...
            return (0, find_js_1.findLegacyCompound)(this.root, word, findOptions);
        }
    ...
    completeWord(text) {
        ...
        const subNodes = (0, trie_util_js_1.iteratorTrieWords)(n || {})
    ...
    suggestWithCost(text, options) {
        ...
        const adjWord = sep ? (0, util_js_1.replaceAllFactory)(sep, '') : (a) => a;
