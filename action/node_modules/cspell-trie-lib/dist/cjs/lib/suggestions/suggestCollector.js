...
const index_js_1 = require("../distance/index.js");
const weightedMaps_js_1 = require("../distance/weightedMaps.js");
const timer_js_1 = require("../utils/timer.js");
const util_js_1 = require("../utils/util.js");
const index_js_2 = require("../walker/index.js");
...
// Add it back later.
const regexSeparator = new RegExp(`[${(0, util_js_1.regexQuote)(index_js_2.WORD_SEPARATOR)}]`, 'g');
...
function suggestionCollector(wordToMatch, options) {
    ...
    const useSeparator = compoundSeparator ||
        (weightMap ? constants_js_1.DEFAULT_COMPOUNDED_WORD_SEPARATOR : exports.defaultSuggestionCollectorOptions.compoundSeparator);
