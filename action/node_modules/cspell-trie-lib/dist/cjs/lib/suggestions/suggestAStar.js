...
const genSuggestionsOptions_js_1 = require("./genSuggestionsOptions.js");
const orthography_js_1 = require("./orthography.js");
const suggestCollector_js_1 = require("./suggestCollector.js");
function* genCompoundableSuggestions(root, word, options) {
    ...
    const wordSeparator = compoundMethod === index_js_1.CompoundWordsMethod.JOIN_WORDS ? index_js_1.JOIN_SEPARATOR : index_js_1.WORD_SEPARATOR;
    ...
    function opReplace(best) {
        ...
        const wg = orthography_js_1.visualLetterMaskMap[wc] || 0;
        const i = best.i + 1;
        const cost = bc + (best.i ? 0 : opCosts.firstLetterBias);
        for (const [s, n] of children) {
            if (s == wc)
                continue;
            const sg = orthography_js_1.visualLetterMaskMap[s] || 0;
...
function suggest(root, word, options) {
    ...
    const collector = (0, suggestCollector_js_1.suggestionCollector)(word, {
