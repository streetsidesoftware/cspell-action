...
class SpellingDictionaryFromTrie {
    ...
    genSuggestions(collector, suggestOptions) {
        ...
        SpellingDictionaryMethods_1.wordSearchFormsArray(collector.word, this.isDictionaryCaseSensitive, ignoreCase).forEach((w) => this.trie.genSuggestions(SpellingDictionaryMethods_1.impersonateCollector(collector, w), _compoundMethod));
    }
    getErrors() {
        return [];
    }
