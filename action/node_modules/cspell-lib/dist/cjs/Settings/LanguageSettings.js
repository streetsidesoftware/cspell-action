...
const SpellSettings = __importStar(require("./CSpellSettingsServer.js"));
...
function calcSettingsForLanguage(languageSettings, languageId, locale) {
    const mapLang = (0, AutoResolve_js_1.autoResolveWeak)(cacheCalcSettingsForLanguage, languageSettings, () => new Map());
    const mapLocale = (0, AutoResolve_js_1.autoResolve)(mapLang, languageId, () => new Map());
