...
const index_js_1 = require("./Controller/configLoader/index.js");
...
function addPathsToGlobalImports(paths) {
    ...
    const error = (0, GlobalSettings_js_1.writeRawGlobalSettings)(globalSettings);
    return {
        success: !error,
        error: error?.message,
        resolvedSettings,
...
function removePathsFromGlobalImports(paths) {
    ...
    const error = toRemove.size > 0 ? (0, GlobalSettings_js_1.writeRawGlobalSettings)(updatedSettings) : undefined;
    return {
        success: true,
        removed: [...toRemove],
