...
const iterableIteratorLib_js_1 = require("./util/iterableIteratorLib.js");
...
function loadWordsNoError(filename) {
    return (0, fileReader_js_1.readLines)(filename).catch((e) => ((0, logger_js_1.logError)(e), (0, iterableIteratorLib_js_1.toIterableIterator)([])));
}
...
function splitLineIntoCodeWords(line) {
    ...
    const wordsToAdd = new Set((0, iterableIteratorLib_js_1.concatIterables)(asMultiWord, asWords, splitWords));
    return (0, iterableIteratorLib_js_1.toIterableIterator)(wordsToAdd);
}
exports.splitLineIntoCodeWords = splitLineIntoCodeWords;
function splitLineIntoWords(line) {
    const asWords = splitLine(line);
    return (0, iterableIteratorLib_js_1.concatIterables)([line], asWords);
}
