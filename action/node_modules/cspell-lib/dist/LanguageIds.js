...
exports.getLanguagesForExt = exports.buildLanguageExtensionMap = exports.isGenerated = exports.isGeneratedExt = exports.isBinary = exports.isBinaryExt = exports.languageIds = exports.generatedFiles = exports.binaryLanguages = exports.languageExtensionDefinitions = void 0;
...
exports.binaryLanguages = new Set(['binary', 'image']);
exports.generatedFiles = new Set([...exports.binaryLanguages, 'map', 'lock', 'pdf']);
exports.languageIds = exports.languageExtensionDefinitions.map(({ id }) => id);
const mapExtensionToLanguageIds = buildLanguageExtensionMap(exports.languageExtensionDefinitions);
...
function getLanguagesForExt(ext) {
    return (0, gensequence_1.genSequence)([ext, '.' + ext])
        .map((ext) => mapExtensionToLanguageIds.get(ext))
        .filter((a) => !!a)
        .concatMap((a) => a) // eslint-disable-line @typescript-eslint/no-non-null-assertion
        .toArray();
}
