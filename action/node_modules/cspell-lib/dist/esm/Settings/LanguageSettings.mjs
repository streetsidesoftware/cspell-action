import { autoResolve, autoResolveWeak, createAutoResolveCache } from '../util/AutoResolve.mjs';
import { doSetsIntersect } from '../util/util.mjs';
import * as SpellSettings from './CSpellSettingsServer.mjs';
