...
import { updateTextDocument } from '../Models/TextDocument.mjs';
import { loadConfigSync, searchForConfigSync } from '../Settings/Controller/configLoader/index.mjs';
import { finalizeSettings, loadConfig, mergeSettings, searchForConfig } from '../Settings/index.mjs';
import { validateInDocumentSettings } from '../Settings/InDocSettings.mjs';
import { getDictionaryInternal, getDictionaryInternalSync } from '../SpellingDictionary/index.mjs';
import { calcSuggestionAdjustedToToMatchCase } from '../suggestions.mjs';
import { catchPromiseError, toError, wrapCall } from '../util/errors.mjs';
import { AutoCache } from '../util/simpleCache.mjs';
import { createTimer } from '../util/timer.mjs';
import { uriToFilePath } from '../util/Uri.mjs';
import { defaultMaxDuplicateProblems, defaultMaxNumberOfProblems } from './defaultConstants.mjs';
import { determineTextDocumentSettings } from './determineTextDocumentSettings.mjs';
import { textValidatorFactory } from './lineValidatorFactory.mjs';
import { createMappedTextSegmenter } from './parsedText.mjs';
...
export class DocumentValidator {
    ...
    *_checkParsedText(parsedTexts) {
    ...
    genSuggestions(text) {
        ...
        const sugsWithAlt = calcSuggestionAdjustedToToMatchCase(text, rawSuggestions, locale, sugOptions.ignoreCase, dict);
