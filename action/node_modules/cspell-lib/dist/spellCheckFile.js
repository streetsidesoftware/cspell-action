...
const isBinaryDoc_1 = require("./Document/isBinaryDoc");
const resolveDocument_1 = require("./Document/resolveDocument");
...
function spellCheckFile(file, options, settings) {
    const doc = {
        uri: (0, Uri_1.toUri)(file).toString(),
    };
...
async function spellCheckDocument(document, options, settings) {
    if ((0, isBinaryDoc_1.isBinaryDoc)(document)) {
        return {
            document,
            options,
    ...
    try {
        return spellCheckFullDocument(await (0, resolveDocument_1.resolveDocument)(document), options, settings);
    }
    catch (e) {
...
async function spellCheckFullDocument(document, options, settings) {
    const doc = (0, resolveDocument_1.documentToTextDocument)(document);
