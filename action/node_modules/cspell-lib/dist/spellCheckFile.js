...
exports.fileToDocument = exports.determineFinalDocumentSettings = exports.spellCheckDocument = exports.spellCheckFile = void 0;
...
function determineFinalDocumentSettings(document, settings) {
    ...
    const languageIds = document.languageId
        ...
        : fileSettings.languageId
            ? fileSettings.languageId
            : LanguageIds_1.getLanguagesForExt(ext);
    if (document.locale) {
...
function isBinaryDoc(document) {
    return isBinaryFile(vscode_uri_1.URI.parse(document.uri).fsPath, document.languageId);
}
function isBinaryFile(filename, languageId) {
    ...
    const languageIds = new Set(languageId.length ? languageId : LanguageIds_1.getLanguagesForExt(ext));
