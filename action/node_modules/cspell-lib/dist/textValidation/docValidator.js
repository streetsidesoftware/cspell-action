...
class DocumentValidator {
    ...
    prepareSync() {
        ...
        const localConfigFn = optionsConfigFile
            ? () => (0, configLoader_1.loadConfigSync)(optionsConfigFile, settings)
            : useSearchForConfig
                ? () => searchForDocumentConfigSync(this._document, settings, settings)
                : undefined;
        const localConfig = localConfigFn && (0, errors_1.wrapCall)(localConfigFn, (e) => this.addPossibleError(e))();
    ...
    async _prepareAsync() {
        ...
        const pLocalConfig = options.configFile
            ? (0, Settings_1.loadConfig)(options.configFile, settings)
            : useSearchForConfig
                ? searchForDocumentConfig(this._document, settings, settings)
                : undefined;
        const localConfig = (await (0, errors_1.catchPromiseError)(pLocalConfig, (e) => this.addPossibleError(e))) || {};
        this.addPossibleError(localConfig?.__importRef?.error);
        const config = (0, Settings_1.mergeSettings)(settings, localConfig);
        const docSettings = (0, determineTextDocumentSettings_1.determineTextDocumentSettings)(this._document, config);
    ...
    *_checkParsedText(parsedTexts) {
        (0, assert_1.default)(this._preparations, ERROR_NOT_PREPARED);
        const { maxNumberOfProblems = defaultConstants_1.defaultMaxNumberOfProblems, maxDuplicateProblems = defaultConstants_1.defaultMaxDuplicateProblems } = this._preparations.validateOptions;
        let numProblems = 0;
    ...
    async function shouldCheck() {
        ...
        const pLocalConfig = options.configFile
            ...
            : useSearchForConfig
                ...
                : undefined;
        const localConfig = (await (0, errors_1.catchPromiseError)(pLocalConfig, addPossibleError)) || {};
