...
function lineValidator(dict, options) {
    const { minWordLength = exports.defaultMinWordLength, flagWords = [], ignoreWords = [], allowCompoundWords = false, ignoreCase = true, ignoreWordsAreCaseSensitive: caseSensitive = true, } = options;
    ...
    const dictCol = new SpellingDictionary_1.SpellingDictionaryCollection([dict, ignoreDict], dict.name, []);
