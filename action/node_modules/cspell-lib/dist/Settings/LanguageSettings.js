...
function calcSettingsForLanguage(languageSettings, languageId, locale) {
    const mapLang = (0, AutoResolve_1.autoResolveWeak)(cacheCalcSettingsForLanguage, languageSettings, () => new Map());
    const mapLocale = (0, AutoResolve_1.autoResolve)(mapLang, languageId, () => new Map());
    return (0, AutoResolve_1.autoResolve)(mapLocale, locale, () => _calcSettingsForLanguage(languageSettings, languageId, locale));
}
