...
async function findPnpAndLoad(uriDirectory, pnpFiles) {
    const found = await (0, find_up_1.default)(pnpFiles, { cwd: (0, Uri_1.uriToFilePath)(uriDirectory) });
...
function findPnpAndLoadSync(uriDirectory, pnpFiles) {
    const found = find_up_1.default.sync(pnpFiles, { cwd: (0, Uri_1.uriToFilePath)(uriDirectory) });
    return loadPnpIfNeeded(found);
}
...
async function _cleanCache() {
    ...
    modules.forEach((r) => r && clear_module_1.default.single((0, Uri_1.uriToFilePath)(r)));
